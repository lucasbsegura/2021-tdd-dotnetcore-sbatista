...
namespace CursoOnline.Dominio.Test.Matriculas
{
    public class MatriculaTest
    {
        ...
        {
            var curso = CursoBuilder.Novo().ComPublic(Dominio.Cursos.PublicoAlvo.Empreendedor).Build();
            var matriculaEsperada = new
            {
                Aluno = AlunoBuilder.Novo().ComPublicoAlvo(Dominio.Cursos.PublicoAlvo.Empreendedor).Build(),
                Curso = curso,
        ...
        {
            var curso = CursoBuilder.Novo().ComValor(100).ComPublic(Dominio.Cursos.PublicoAlvo.Empreendedor).Build();
        ...
        {
            var curso = CursoBuilder.Novo().ComPublic(Dominio.Cursos.PublicoAlvo.Empregado).Build();
            var aluno = AlunoBuilder.Novo().ComPublicoAlvo(Dominio.Cursos.PublicoAlvo.Universitário).Build();
